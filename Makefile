...
# Template: app
# Command: /usr/bin/qmake6 -o Makefile ContactBook.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ContactBook1.0.0
DISTDIR = /home/runner/work/contactbook/contactbook/.tmp/ContactBook1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		ContactBook.pro mywidget.h main.cpp \
		mywidget.cpp
QMAKE_TARGET  = ContactBook
DESTDIR       = 
TARGET        = ContactBook
...
ContactBook: ui_mywidget.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ContactBook.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile ContactBook.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mywidget.ui $(DISTDIR)/
...
moc_mywidget.cpp: mywidget.h \
	...
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/runner/work/contactbook/contactbook/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/runner/work/contactbook/contactbook -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -IC:/Qt/Tools/mingw1310_64/lib/gcc/x86_64-w64-mingw32/13.1.0/include/c++ -IC:/Qt/Tools/mingw1310_64/lib/gcc/x86_64-w64-mingw32/13.1.0/include/c++/x86_64-w64-mingw32 -IC:/Qt/Tools/mingw1310_64/lib/gcc/x86_64-w64-mingw32/13.1.0/include/c++/backward -IC:/Qt/Tools/mingw1310_64/lib/gcc/x86_64-w64-mingw32/13.1.0/include -IC:/Qt/Tools/mingw1310_64/lib/gcc/x86_64-w64-mingw32/13.1.0/include-fixed -IC:/Qt/Tools/mingw1310_64/x86_64-w64-mingw32/include mywidget.h -o moc_mywidget.cpp
...
ui_mywidget.h: mywidget.ui \
	...
	/usr/lib/qt6/libexec/uic mywidget.ui -o ui_mywidget.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/ContactBook/bin || mkdir -p $(INSTALL_ROOT)/opt/ContactBook/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/ContactBook/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/ContactBook/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/ContactBook/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/ContactBook/bin/ 
